package jcarpe.ui
{
	...
	public class ToolTip extends Sprite
	{
		...
		private var _bubbleGFX:Sprite 				= new Sprite();
		...
		// CONSTRUCTOR
		// --------------------------------------------------------------------------------
		public function ToolTip( _text:String = "", _textColor:uint = 0x000000, _textSize:Number = 12, _textFont:Font = null, _bgColor:uint = 0xFFFFFF, _outlineColor:uint = 0x000000, _outlineThickness:Number = 1, _cornerBevel:Number = 0, _arrowPosition:String = ToolTipArrowPosition.BOTTOM_CENTER, _arrowHeight:Number = 15, _arrowWidth:Number = 12, _padding:Number = 5, _maxWidth:Number = 200 )
		{
			text 							= _text;
		...
		private function render() : void
		{
			...
			if( textFont != null ) { _textFormat.font	= textFont.fontName; }
			...
			if( textFont != null ) { _textField.embedFonts = true; }
